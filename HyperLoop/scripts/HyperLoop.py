...
class HyperLoop:
    ...
    def copy_hyperopt_results(self, run_dir: Path) -> None:
        """
                ...
                if strategy_json.exists():
                    ...
                    try:
                        ...
                        if attempt < max_retries - 1:
                            ...
                            raise RuntimeError(f"Strategy JSON file found but not readable: {strategy_json}")
                time.sleep(0.5)

            # Check if any freqtrade hyperopt processes are still running
    ...
    def run_loop(self) -> None:
        ...
        for i in range(1, self.num_runs + 1):
            ...
            try:
                ...
                self.copy_hyperopt_results(run_dir)
